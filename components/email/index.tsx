				...
				<Section>
					<Container className='w-[580px] pt-[20px] pb-[48px] pr-0'>
						...
						<Section className='pb-5'>
							<Row>
								<div className='w-full !h-[100px] break-words whitespace-normal text-[32px] leading-[4rem] font-bold text-[#484848]'>
									{props.spaceName}
								</div>
								...
								<Text className='text-[18px] leading-[1.4] text-[#484848] pb-4'>
									If you have any questions or concerns, we&lsquo;re always here
									to help. Reach out to us on our Socials. Thanks for your
									continued support of {props.spaceName}. We can&lsquo;t wait to
									hear your input on this important decision-making process!
								</Text>
								<Text className='text-[18px] leading-[1.4] text-[#484848] pb-4'>
