...
export const NewProposalEmail = (props: NewProposalEmailProps) => {
	...
	return (
		...
		>
			<Container className='bg-white font-segoe pt-[20px] pb-[48px] px-4'>
				<Section>
					<Img
				...
				<Section>
					<Img
						src={
							props.spaceLogo !== ''
								? `https://ipfs.io/ipfs/${props.spaceLogo.slice(7)}`
								: 'https://pbs.twimg.com/profile_images/1567816867078701056/oJEhzzx9_400x400.png'
						}
						width='96'
						height='96'
						alt={props.spaceName}
				...
				<Section className='pb-5'>
					<Row>
						...
						<Text className='text-[18px] leading-[1.4] text-[#484848]'>
							Voting is open now and will remain open until {endDate}. To vote,
							simply connect to our DAO using your favorite Web3-enabled wallet
							and review the proposal.
						</Text>
						<Text className='text-[18px] leading-[1.4] text-[#484848] pb-4'>
							If you have any questions or concerns, we&lsquo;re always here to
							help. Reach out to us on our Socials. Thanks for your continued
							support of {props.spaceName}. We can&lsquo;t wait to hear your
							input on this important decision-making process!
						</Text>
						<Text className='text-[18px] leading-[1.4] text-[#484848] pb-4'>
